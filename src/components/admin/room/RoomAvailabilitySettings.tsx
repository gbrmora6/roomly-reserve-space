...
export const RoomAvailabilitySettings: React.FC<RoomAvailabilitySettingsProps> = ({
  roomId,
  roomName,
  minimumInterval = 60,
  ...
  const { blocks, isLoading, addBlock, removeBlock } = useManualBlocks('room', roomId);
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle>Configurações de Disponibilidade - {roomName}</CardTitle>
        </CardHeader>
