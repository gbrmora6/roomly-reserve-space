...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      {/* Background Elements */}
        ...
        <div className="grid items-center gap-8 lg:gap-12 lg:grid-cols-2">
          ...
          <div className="text-center lg:text-left space-y-6 md:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center lg:justify-start">
              <Button size="lg" className="group bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105 px-6 md:px-8 py-3 md:py-4 text-sm md:text-base" onClick={() => navigate("/register")}>
                Comece Agora
                <ArrowRight className="ml-2 h-4 w-4 md:h-5 md:w-5 group-hover:translate-x-1 transition-transform duration-300" />
              </Button>
              <Button size="lg" variant="outline" className="group border-2 border-primary/20 text-primary hover:bg-primary/5 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-500 transform hover:scale-105 px-6 md:px-8 py-3 md:py-4 text-sm md:text-base" onClick={() => navigate("/rooms")}>
          ...
          <div className="relative">
            <div className="relative group">
              ...
              <div className="relative bg-white/10 backdrop-blur-sm rounded-3xl p-2 shadow-2xl border border-white/20 transform transition-all duration-700 hover:scale-105 hover:rotate-1">
                <img src={heroImageUrl} alt="Ambiente profissional para psicólogos" className="w-full h-64 sm:h-80 md:h-96 lg:h-[500px] object-cover rounded-2xl shadow-xl" />
