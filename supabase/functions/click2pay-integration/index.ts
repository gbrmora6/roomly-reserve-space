...
serve(async (req) => {
  ...
  try {
    ...
    console.log("18. Status da resposta Click2Pay:", click2payResponse.status);
    
    const click2payResult = await click2payResponse.json();
    console.log("19. Resposta Click2Pay:", JSON.stringify(click2payResult, null, 2));
    ...
    console.log("20. Atualizando ordem com dados da Click2Pay...");
    ...
    if (click2payResult.status === 'paid') {
      console.log("21. Confirmando pagamento do carrinho...");
