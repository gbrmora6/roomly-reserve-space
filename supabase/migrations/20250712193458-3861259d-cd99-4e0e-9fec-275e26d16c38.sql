-- Corrigir função get_room_availability para incluir o horário de fechamento
...
BEGIN
  ...
  -- Gerar horários disponíveis (CORRIGIDO: incluir o horário de fechamento)
...
-- Corrigir função get_equipment_availability para incluir o horário de fechamento
