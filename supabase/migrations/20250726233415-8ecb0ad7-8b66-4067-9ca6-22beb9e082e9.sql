-- Corrigir função create_reservations_for_checkout removendo referências a updated_at que não existe em cart_items
      ...
      IF cart_item.item_type IN ('room', 'equipment') AND 
        ...
        ELSIF cart_item.item_type = 'equipment' THEN
          ...
          AND (
            ...
            OR (be.start_time >= v_start_time AND b.end_time <= v_end_time)
          );
